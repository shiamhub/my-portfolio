...
const Navbar = () => {
    ...
    return (
        <div className="bg-transparent fixed right-0 left-0 top-0 z-50">
            <div className="navbar w-10/12 mx-auto">
                    <a className="btn btn-ghost normal-case text-xl">SSA</a>
                <div className="navbar-end w-full">
                    <div className="dropdown">
                        <label tabIndex={0} className="btn btn-ghost lg:hidden">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /></svg>
                        </label>
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52 right-0">
                            {options}
                        </ul>
                    </div>
                </div>
